  ...
  return (
    <>
      <div
        ...
        className="text-left flex justify-start items-center py-20 px-10"
      >
        <div className="w-full md:w-1/2 text-white font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-4 md:px-10">
          ...
          <div className="shadow-xl p-6">
            ...
            <form className="">
              ...
              <div className="flex items-center mb-6 p-4 border">
              ...
              <button
                type="submit"
                className="bg-blue-600 text-white text-xl px-6 py-4 font-bold w-full md:w-auto mt-4 hover:bg-blue-700 transition"
              >
                Submit
              </button>
            </form>
