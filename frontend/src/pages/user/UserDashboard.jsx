...
import { IoLogOutOutline, IoKeyOutline, IoHelpCircleOutline } from "react-icons/io5";
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="w-full bg-gray-800 text-white py-4 px-6 flex justify-between items-center shadow-md">
        <h1 className="text-3xl font-semibold tracking-tight text-white">User Dashboard</h1>
          ...
          <div className="space-y-4">
            <button
              ...
              className={`w-full py-3 px-4 text-left text-gray-700 rounded-md flex items-center transition-all ${
                activeTab === "profile" ? "bg-gray-800 text-white" : "hover:bg-gray-100"
              }`}
            >
            ...
            <button
              ...
              className={`w-full py-3 px-4 text-left text-gray-700 rounded-md flex items-center transition-all ${
                activeTab === "orders" ? "bg-gray-800 text-white" : "hover:bg-gray-100"
              }`}
            >
            ...
            <button
              ...
              className={`w-full py-3 px-4 text-left text-gray-700 rounded-md flex items-center transition-all ${
                activeTab === "messages" ? "bg-gray-800 text-white" : "hover:bg-gray-100"
              }`}
            >
            ...
            <button
              ...
              className={`w-full py-3 px-4 text-left text-gray-700 rounded-md flex items-center transition-all ${
                activeTab === "wishlist" ? "bg-gray-800 text-white" : "hover:bg-gray-100"
              }`}
            >
            ...
            <button
              ...
              className={`w-full py-3 px-4 text-left text-gray-700 rounded-md flex items-center transition-all ${
                activeTab === "settings" ? "bg-gray-800 text-white" : "hover:bg-gray-100"
              }`}
            >
            ...
            <button
              ...
              className={`w-full py-3 px-4 text-left text-gray-700 rounded-md flex items-center transition-all ${
                activeTab === "help and support" ? "bg-gray-800 text-white" : "hover:bg-gray-100"
              }`}
            >
