...
//   const handleAddPropertySubmit = useCallback((newProperty) => {
...
//             </div>
//           </div>
//           <PropertyForm onSubmit={handleAddPropertySubmit} />
//         </div>
//       ) : (
...
const PropertyTab = () => {
  ...
  const handleEdit = useCallback(
    (index) => {
      setEditingProperty(propertyList[index]); // Set the property to be edited
      setIsAddingProperty(true); // Show the property form
    },
    [propertyList]
  );
              ...
              {filteredProperties.map((property, index) => (
                ...
                >
                  ...
                  <div className="p-2">
                    ...
                    <p className="text-xs text-gray-500">{property.type}</p>
                    <p className="text-xs text-gray-700 mt-2">{property.details}</p>
                    <p className="text-xs text-gray-700 mt-2">{property.address}</p>
