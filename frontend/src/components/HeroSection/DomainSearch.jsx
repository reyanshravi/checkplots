...
const DomainSearch = () => {
  ...
  const [activeTab1, setActiveTab1] = useState("rent"); // Rent or Buy
  const [activeTab2, setActiveTab2] = useState("residential"); // Residential or Commercial
  const [activeTab3, setActiveTab3] = useState("flat"); // Flat or Property
  ...
  return (
    <div className="container mx-auto bg-black bg-opacity-40 rounded-lg px-6 pt-4 sm:p-8 w-full sm:w-11/12 md:w-2/3 lg:w-1/2 shadow-xl z-10">
      ...
      <form>
        ...
        <div
          className={`mt-4 bg-gray-200 p-6 rounded-lg transition-all ease-in-out ${
            filterOpen
